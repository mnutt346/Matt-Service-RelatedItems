...
var _relateditems = __webpack_require__(7);
...
var Related = function (_React$Component) {
  ...
  _createClass(Related, [{
    ...
    value: function fetchItems() {
      ...
      fetch('http://localhost:3004/related').then(function (data) {
        return data.json();
      }).then(function (json) {
        var newState = {};
        newState.items = json;
      ...
      return _react2.default.createElement(
        ...
        this.state.items.map(function (item, i) {
          if (i < 5) {
            return _react2.default.createElement(
              'div',
              { key: i, className: 'item-name' },
              item.name,
              _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('img', { src: item.fullimg })
              ),
              _react2.default.createElement(
                'div',
                { className: 'blurb' },
